...
def main():
    ...
    # ------------------------------------------------------------------
    # d: 8. Uncomment the tests below before working TO DO 9.
...
def draw_shapes(shapes, window):
    ...
    """
    # ------------------------------------------------------------------
    # d: 9. Implement and test this function. Make sure you do TO DO 8 in main first!
